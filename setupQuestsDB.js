...
db.serialize(() => {
	...
	const quests = [
		...
		{ quest_id: 45, region: 'Galar', collection_name: 'w Extremist', description: 'Galar Legendary Birds', reward: 'Lootbox', required_pokemon: '144-146', required_forms: JSON.stringify({'144': ['Galarian'], '145': ['Galarian'], '146': ['Galarian']}), poke_count: 3, contributor: 'Dillon', note: '' },
