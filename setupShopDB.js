...
db.serialize(() => {
	...
	const shopItems = [
		...
		{ itemNum: 527, item_name: 'Star Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: Star trim for Furfrou transformation' },
		{ itemNum: 528, item_name: 'Diamond Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: Diamond trim for Furfrou transformation' },
		{ itemNum: 529, item_name: 'Debutante Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: Debutante trim for Furfrou transformation' },
		{ itemNum: 530, item_name: 'Matron Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: Matron trim for Furfrou transformation' },
		{ itemNum: 531, item_name: 'Dandy Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: Dandy trim for Furfrou transformation' },
		{ itemNum: 532, item_name: 'La Reine Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: La Reine trim for Furfrou transformation' },
		{ itemNum: 533, item_name: 'Kabuki Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: Kabuki trim for Furfrou transformation' },
		{ itemNum: 533, item_name: 'Pharaoh Trim', item_class: 1, pokemon_usage: 'Furfrou', new_form: 'Heart Trim', reusable: 0, price: 250, drop_class: 'common', drop_rate: common / 9, explanation: '**CONSUMABLE**: Pharaoh trim for Furfrou transformation' },
